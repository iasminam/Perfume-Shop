...
<section class="heading">
    <h3>lista ta de dorințe</h3>
    <p> <a href="home.php">acasă</a> / lista de dorințe </p>
</section>
...
<section class="wishlist">
    ...
    <form action="" method="POST" class="box">
        ...
        <img src="parfumuri/<?php echo $fetch_wishlist['image']; ?>" alt="" class="image">
        <div class="name"><?php echo $fetch_wishlist['name']; ?></div>
        <div class="price"><?php echo $fetch_wishlist['price']; ?> Lei</div>
    ...
    $grand_total += $fetch_wishlist['price'];
        ...
        echo '<p class="empty">lista ta de dorințe este goală</p>';
    }
    ?>
    </div>

    <div class="wishlist-total">
        <p>Total : <span><?php echo $grand_total; ?> Lei</span></p>
        <a href="shop.php" class="option-btn">continuă cumpărăturile</a>
        <a href="wishlist.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('delete all from wishlist?');">șterge tot</a>
    </div>
