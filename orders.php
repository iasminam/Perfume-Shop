...
<section class="heading">
    ...
    <p> <a href="home.php">acasă</a> / comenzi </p>
</section>
...
<section class="placed-orders">
    ...
    <div class="box">
        ...
        <p> Comanda ta : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
        <p> Preț total : <span><?php echo $fetch_orders['total_price']; ?> Lei</span> </p>
        <p> Starea plății : <span style="color:<?php if($fetch_orders['payment_status'] == 'pending'){echo 'tomato'; }else{echo 'green';} ?>"><?php echo $fetch_orders['payment_status']; ?></span> </p>
    </div>
    <?php
        }
    }else{
        echo '<p class="empty">Încă nu au fost plasate comenzi!</p>';
    }
    ?>
    </div>
