...
<section class="shopping-cart">
    ...
    <div  class="box">
        ...
        <img src="parfumuri/<?php echo $fetch_cart['image']; ?>" alt="" class="image">
        <div class="name"><?php echo $fetch_cart['name']; ?></div>
        <div class="price"><?php echo $fetch_cart['price']; ?> Lei</div>
        ...
        <div class="sub-total"> sub-total : <span><?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?> Lei</span> </div>
    </div>
    <?php
    ...
    <div class="more-btn">
        <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('delete all from cart?');">sterge tot</a>
    </div>
